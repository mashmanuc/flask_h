...
# Лічильник для відстеження прогресу завантаження тестів
test_counter = 0
        ...
        for tema_test in tema_tests:
            ...
            if table_info:
                ...
                for test in tests:
                    ...
                    print("Додано  test_id >>",test_id)
                    # Додавання тесту в колекцію tests
                    collection_tests.insert_one(test_data)
                    test_counter += 1
                    if test_counter % 1000 == 0:
                        print(f"Завантажено {test_counter} тестів.")
            ...
            print("Додано  tema_test_id >>",tema_test_id)
...
print(f"Загальна кількість завантажених тестів: {test_counter}")